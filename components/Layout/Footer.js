                ...
                <div className="about-us-widget">
                  <Link href="/">
                    <a className="footer-logo d-block">
                      <img src="img/logo-white.png" alt="flikoston" />
                    </a>
                  </Link>
                  <p>
                    Flikoston helps hundreds of people get the best Wordpress
                    and Frontend services and offers website maintenance,
                    management and reproduction services.
                  </p>
                </div>
              </div>
            </div>
