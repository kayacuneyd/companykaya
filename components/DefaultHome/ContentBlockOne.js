        ...
        <div className="row align-items-center">
          <div className="col-xl-5 pe-lg-0 col-lg-5 col-12">
            <div className="block-img wow fadeInLeft" data-wow-duration="1.1s">
              <img src="img/flikoston-cta-light-photo.png" alt="" />
            </div>
          </div>
          <div className="col-xl-6 col-lg-7 offset-xl-1 col-12 ps-lg-5 pe-xl-5">
            <div className="block-contents ms-xl-3 mt-5 mt-lg-0">
              ...
              >
                ...
                get convenient interest on sending & receiving money.
              </p>
              <p
                className="wow fadeInUp"
                data-wow-duration="1s"
                data-wow-delay=".4s"
              >
                As this guide explains, investing in cryptocurrency comes with a
                ton of benefits. You do want to make sure you vet a currency
                before investing in it.
              </p>
              <a
                href="#"
                className="theme-btn-orange mt-30 wow fadeInUp"
                data-wow-duration="1s"
                data-wow-delay=".6s"
              >
                Get Started
